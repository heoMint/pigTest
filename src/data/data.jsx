export const qnaList = [
  ...
  //         type: ["romanticist", "something", "sociability", "muscle",waterWeight",'lazy','mutation'],
  //     },
  //     { answer: "c. 치킨은 나눌 수 없다. 1인 1닭이다.", type: ["perfectPig", 'chopsticks'] },
  //     ],
  // },
  // {
  ...
  //     a: [
  //     {
  //         answer: "a. 꽃이 너무 아름다워서 지나칠 수 없다. 꽃을 사서 기분전환한다.",
  ...
  //         type: ["dietPill", "sociability", "muscle", "waterWeight"],
  //     },
  //     ],
  // },
  // {
  ...
  //     a: [
  //     { answer: "a. 구매는 선택이다. 당당하게 먹고 간다.", type: ["perfectPig", "cheeky", "waterWeight"] },
  //     {
  //         answer: "b. 먹었는데 맛은 있지만 살 정도는 아닌데 아주머니의 세일즈력에 얼떨결에 계산한다.",
  //         type: ["chopsticks", "lazy", "sociability",'romanticist','dietPill'],
  //     },
  //     {
  //         answer:
  //         'c. 시식코너에는 눈조차 주지 않고 살 것만 산다.',
  ...
  //         type: ["rabbit", "lazy", "cheeky", "sociability", "romanticist", "dietPill",'designedly'],
  //     },
  //     { answer: "c. 개인 음식 위주로 먹고 공통음식은 거의 안먹는다.", type: ["muscle", "mutation"] },
  //     ],
  // },
  // {
  ...
  //     a: [
  //     {
  //         answer: "a. 내 음식을 뺏어 먹으려는 줄 알고 깜짝 놀라 입에 쑤셔 넣었다.",
  ...
  //     },
  //     {
  //         answer: "c. 사랑스러운 마이-씨스타✨ 맛있는 케이크 먹어보라고 한 입 준다.",
  ...
  //         type: ["perfectPig", "cheeky", "waterWeight",'chopsticks','designedly'],
  //     },
  //     {
